import * as Dialog from "@radix-ui/react-dialog" // Funcionalidade p/ Modal
                        ...
                        <div className='flex flex-1 flex-col gap-3 p-5'>
                            ...
                            (
                                <p className='text-sm leading-6 text-slate-400'>
                                    Comece <button type="button" className="font-md text-lime-400 hover: underline" onClick={handleStartRecording}> gravando uma nota </button> em aúdio ou se preferir <button type="button" className="font-md text-lime-400 hover: underline" onClick={handleStartEditar}> utilize apenas texto </button>.
                                </p>
                            ) : (
